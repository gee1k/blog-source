...
![腾讯云配置](https://r2.svend.cc/tutorials/tencent-host.png)
...
![基本信息](https://r2.svend.cc/tutorials/tencent-info.png)

`注意读写权限需要设置可公共读取，不然上传完成之后无法通过 URL 访问哦。可在存储空间的基础设置里更改权限。`
![权限设置](https://r2.svend.cc/tutorials/tencent-info-2.png)

## 🔑 密钥获取(SecretId、SecretKey)

**进入个人中心 [密钥管理](https://console.cloud.tencent.com/cam/capi) 查看**
![密钥](https://r2.svend.cc/tutorials/tencent-ak.png)
