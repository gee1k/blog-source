...
<div align="center">
  <img src="https://raw.githubusercontent.com/gee1k/uPic/master/screenshot/logo.png" alt="uPic">
</div>
...
| 功能 | 描述 | 预览 |
| --- | --- | --- |
| **🖥 选择文件上传** | 从`Finder`选择文件上传 | ![](https://raw.githubusercontent.com/gee1k/uPic/master/screenshot/selectFile.gif) |
| **⌨️ 复制文件上传** | 上传已拷贝到剪切板的文件 | ![](https://raw.githubusercontent.com/gee1k/uPic/master/screenshot/paste.gif) |
| **🖱 拖拽本地文件上传** | 拖拽文件到状态栏上传 | ![](https://raw.githubusercontent.com/gee1k/uPic/master/screenshot/drag-finder.gif) |
| **🖱 拖拽浏览器图片上传** | 从浏览器拖拽图片到状态栏上传 | ![](https://raw.githubusercontent.com/gee1k/uPic/master/screenshot/drag-browser.gif) |
| **📸 截图上传** | 直接拉框截图上传 | ![](https://raw.githubusercontent.com/gee1k/uPic/master/screenshot/screenshot.gif) |
| **📂 Finder 中右键上传** | 右击文件上传 | ![](https://raw.githubusercontent.com/gee1k/uPic/master/screenshot/finder-contextmenu.gif) |
...
| 功能 | 描述 | 预览 |
| --- | --- | --- |
| **⚙️ 配置图床** | 在`偏好设置`中可配置图床。支持同一类型图床可配置多个实例 | ![](https://raw.githubusercontent.com/gee1k/uPic/master/screenshot/hosts.png)        |
| **🔦 选择图床** | 配置好的图床可以在菜单栏`图床`中看到，并选择您接下来要上传到的图床 | ![](https://raw.githubusercontent.com/gee1k/uPic/master/screenshot/default-host.png) |
...
| 功能 |  | 预览 |
| --- | --- | --- |
| **⌨︎ 全局快捷键** | | ![](https://raw.githubusercontent.com/gee1k/uPic/master/screenshot/shortcuts.png) |
| **🕦 上传历史** | | ![](https://raw.githubusercontent.com/gee1k/uPic/master/screenshot/history.png) |
| **📢 更多功能等待你发现** | | ... |
